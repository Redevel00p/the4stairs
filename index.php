...
<body class="bg-jazz-darkest text-jazz-light font-body flex flex-col min-h-screen overflow-x-hidden">
    ...
    <main class="max-w-6xl mx-auto px-6 py-16 flex-grow w-full">
        ...
        <section id="upcoming-specials-section" class="mb-20">
            ...
            <div class="text-center mt-12">
                <a href="event" class="inline-block bg-zinc-900 hover:bg-amber-500/10 border border-white/10 hover:border-amber-500 text-white font-bold uppercase tracking-wider text-xs px-8 py-3.5 rounded-lg transition-all duration-300">Lihat Semua Event Spesial</a>
            </div>
        </section>
    </main>
