 ...
 * ------------------------------------------------
 * Artikel: Akhirnya ini Websitenya Publish juga YEY
 * Template: concert
 */
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Akhirnya ini Websitenya Publish juga YEY - The 4 Stairs Music Hall</title>
    <!-- Tailwind CSS CDN -->
    ...
    <main class="max-w-4xl mx-auto px-6 py-12 flex-grow w-full">
        ...
        <article class="bg-jazz-card/90 border border-jazz-gold/30 rounded-3xl shadow-[0_0_50px_rgba(139,30,34,0.05)] p-8 md:p-12 relative overflow-hidden">
            ...
            <div class="pb-6 mb-8 border-b border-white/10">
                ...
                <h1 class="font-heading text-3xl md:text-5xl font-bold tracking-tight text-white leading-tight mb-4 drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Akhirnya ini Websitenya Publish juga YEY</h1>
            ...
            <div class="prose prose-invert max-w-none text-justify text-gray-300 leading-relaxed font-light">
                YEEEEEEEEEEEYYYY<div><br></div><div>GG</div>
            </div>
