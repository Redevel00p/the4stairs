    ...
    <main class="max-w-6xl mx-auto px-6 py-16 flex-grow w-full">
        ...
        <section id="kontak" class="mb-12 scroll-mt-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Contact Card 3: Kontak & Media Sosial -->
                <div class="glass-card rounded-xl p-8 border border-white/5 text-center flex flex-col items-center justify-between">
                    <div class="flex flex-col items-center w-full">
                        ...
                        <h3 class="text-white text-base font-semibold uppercase tracking-wider mb-3">Hubungi & Ikuti Kami</h3>
                        <p class="text-jazz-muted text-xs font-light leading-relaxed mb-6">
                            Tanyakan info reservasi tiket grup, penyewaan hall, kerjasama, atau ikuti terus update terbaru kami.
                        </p>
                        
                        <!-- Primary Contacts: WA and Email -->
                        <div class="flex flex-col sm:flex-row gap-3 w-full mb-6">
                            <a href="https://wa.me/628123456789" target="_blank" class="flex-1 inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold uppercase tracking-wider text-[9px] py-2.5 px-4 rounded-lg shadow-lg hover:shadow-green-600/20 transform hover:-translate-y-0.5 transition-all duration-300">
                            ...
                            <a href="mailto:info@the4stairs.com" class="flex-1 inline-flex items-center justify-center gap-2 bg-zinc-900 hover:bg-jazz-gold/15 border border-white/10 hover:border-jazz-gold text-white font-bold uppercase tracking-wider text-[9px] py-2.5 px-4 rounded-lg transform hover:-translate-y-0.5 transition-all duration-300">
                                <svg class="w-3.5 h-3.5 text-jazz-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="w-full border-t border-white/5 my-4"></div>
                        <span class="text-jazz-muted text-[10px] uppercase tracking-widest font-semibold mb-3.5 block">Ikuti Media Sosial Kami</span>
                        
                        <!-- Socials Icons Row -->
                        <div class="flex items-center justify-center gap-4">
                            <!-- Facebook -->
                            <a href="https://facebook.com/the4stairs" target="_blank" class="w-8 h-8 rounded-full bg-white/5 border border-white/10 hover:border-blue-500 hover:bg-blue-500/10 hover:text-blue-400 flex items-center justify-center text-gray-400 transition-all duration-300" title="Facebook">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <!-- Instagram -->
                            <a href="https://instagram.com/the4stairs" target="_blank" class="w-8 h-8 rounded-full bg-white/5 border border-white/10 hover:border-pink-500 hover:bg-pink-500/10 hover:text-pink-400 flex items-center justify-center text-gray-400 transition-all duration-300" title="Instagram">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
                            ...
                            <!-- YouTube -->
                            <a href="https://youtube.com/the4stairs" target="_blank" class="w-8 h-8 rounded-full bg-white/5 border border-white/10 hover:border-red-600 hover:bg-red-600/10 hover:text-red-500 flex items-center justify-center text-gray-400 transition-all duration-300" title="YouTube">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
